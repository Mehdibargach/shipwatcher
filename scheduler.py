...
Note: Keep-alive pings removed — they kept Free tier services awake 24/7,
burning through Render's 750 free instance hours/month.
Services now sleep when idle and wake on real traffic (~30s cold start).
"""
